...
while numbeers != 1
  numbeers = numbeers - 1
  numbeers_written = englishNumber(numbeers)
  puts numbeers_written.to_s + ' bottles of beer on the wall...'
  puts numbeers_written.to_s + ' bottles of beer!'
  puts 'take one down and pass it around...'
  numbeers_written = englishNumber(numbeers - 1)
  puts (numbeers_written).to_s + ' bottles of beer on the wall!'
  puts ''
end
