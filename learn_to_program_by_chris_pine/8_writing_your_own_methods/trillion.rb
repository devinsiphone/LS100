# I think 'one trillion' would be a nicer return value for that last number, or
# even  'one million million' (though all three are correct). In fact, you can
# do that right now...
# Expand upon englishNumber some more. Now put in millions, so you get
# 'one million' instead of 'one thousand thousand'. Then try adding billions and
...
def englishNumber number
  ...
  write = left / 1000000000000 # How many trillions left to write out?
	left = left - write * 1000000000000 # Subtract off those billions.
